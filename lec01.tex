...
\newcommand{\lecture}[4]{
   ...
   \framebox{
      \vbox{\vspace{2mm}
    \hbox to 6.28in { {\bf CS 405/6001: Game Theory and Algorithmic Mechanism Design
	\hfill Jul-Nov 2025} }
       \vspace{4mm}
       \hbox to 6.28in { {\Large \hfill Lecture #1: #2  \hfill} }
       \vspace{2mm}
       \hbox to 6.28in { {\it Lecturer: #3 \hfill Scribe group: #4} }
      \vspace{2mm}}
   }
   \end{center}
...
%    This LaTeX template is by courtesy of UC Berkeley EECS dept.
   ...
   {\bf Disclaimer}: {\it These notes aggregate content from several texts and have not been subjected to the usual scrutiny deserved by formal publications. If you find errors, please bring to the notice of the Instructor.}
   \vspace*{1mm}
}
%
...
\lecture{1}{Introduction to Game Theory and Mechanism Design}{Swaprava Nath}{Group number}
